...
module.exports = {
  db: {
    uri: 'mongodb://aguiareduardo:vitoriaES01@ds127564.mlab.com:27564/pyn_database', //process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/mean-dev',
    options: {},
